...
const Terms = () => {
  return (
    <div className={styles.container}>
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Eat the Strip</li>
        <li>Sell, rent or sub-license material from Eat the Strip</li>
        <li>Reproduce, duplicate or copy material from Eat the Strip</li>
        <li>Redistribute content from Eat the Strip</li>
      </ul>
